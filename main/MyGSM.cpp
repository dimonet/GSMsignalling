...
#define TIME_DIAGNOSTIC    150000/*1800000*/              // время проверки gsm модуля (раз в пол часа). Если обнаружено что gsm не отвечает или потерял сеть то устройство перезагружается автоматически
