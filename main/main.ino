...
const byte timeHoldingBtn = 2;                             // время удерживания кнопки для включения режима охраны  3 сек.
...
const unsigned long timeRefreshVcc = 4000;                 // время паузы после последнего измерения питания (милисекунды)

// Спикер
#define specerTone 98                                      // тон спикера

// Количество нажатий на кнопку для включений режимова
#define countBtnBalance 2                                  // количество нажатий на кнопку для запроса баланса счета
