...
const int  timeAfterPressBtn = 5000;                       // время удерживания кнопки для включения режима охраны  (милисекунды).
...
unsigned int  prLastPressBtn = 0;                  // время последнего нажатие на кнопку (милисекунды)
